...
if MsgText[2] == "قائمه الحمار" then
if not msg.Rank then end
...
return '👨🏾‍🔧│ اصدار سورس ام فور : *v'..version..'* \n📡'
end
...
local inline = {{{text="⚜│قناه السـورس ضـغـط هنا ",url="t.me/zkxd18"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : فهاوه](t.me/zkxd18)',nil,inline,msg.id_)
return false
end
...
return [[
┄─┅══┅─┄     
👋│اهلا بك في سورس JERRY ☠️🔱
●ـ▬ـ▬ஜ۩۞۩ஜ▬ــ●
⚜️|[مطور السورس](https://t.me/zkxd18)
]]
end
...
آختصاصي حمـايةة آلمـجمـوعآت
من آلسبآم وآلتوجيةة‌‏ وآلتكرار وآلخ...

ً.        لتفعيل البوت اتبع مايلي
١- اضف البوت الى المجموعه
٢- ارفع البوت مشرف في المجموعه
٣- وارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القروب تلقائين
...
³↫ ❬وارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القروب تلقائياً ❭ 
